...
enum HallucinationFilter {
    ...
    static let noSpeechAverageThreshold: Double = AppConfig.Hallucination.noSpeechAverageThreshold
    static let noSpeechMaxThreshold:     Double = AppConfig.Hallucination.noSpeechMaxThreshold

    // MARK: - Known hallucination phrases (Android parity)
    static let knownPhrases: Set<String> = AppConfig.Hallucination.knownPhrases
    ...
    static func passes(text: String, segments: [[String: Any]]?) -> Bool {
