...
public final class OpenAICompatibleProvider: SpeechProvider {
    ...
    public func transcribe(
        ...
        // Only pass the language parameter when the user has explicitly chosen one.
        // An empty / nil language lets Whisper auto-detect the spoken language.
        // Sending "en" here would force Whisper to translate non-English speech
        // into English — we must never do that.
