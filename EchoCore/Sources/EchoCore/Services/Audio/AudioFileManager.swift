...
public struct DefaultFileSystem: FileSysteming {
    public init() {}
    public func fileExists(atPath path: String) -> Bool {
        FileManager.default.fileExists(atPath: path)
    }
    public func createDirectory(at url: URL, withIntermediateDirectories create: Bool) throws {
...
public final class AudioFileManager {
    ...
    public func newRecordingURL() throws -> URL {
    ...
    public func delete(fileURL: URL) {
    ...
    public func cleanupOldRecordings(olderThan days: Int = 30) {
