...
public struct SecurityKeychainBackend: KeychainBackend {
    public init() {}
    public func read(service: String, account: String, accessGroup: String?) -> Data? {
    ...
    public func save(_ data: Data, service: String, account: String, accessGroup: String?) -> OSStatus {
    ...
    public func delete(service: String, account: String, accessGroup: String?) -> OSStatus {
...
public final class KeychainStore {
    public static let defaultService = "com.mirailabs.echo.provider-credentials"
    ...
    public func saveKey(_ key: String, for provider: String) {
    ...
    public func clearKey(for provider: String) {
        _ = backend.delete(
            service: service,
            account: keyAccount(provider),
            accessGroup: accessGroup
    ...
    public func clearBaseURL(for provider: String) {
        _ = backend.delete(
            service: service,
